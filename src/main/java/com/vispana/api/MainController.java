...
public class MainController {
    ...
    public String updateDocument(
        ...
        return vespaDocumentClient.postDocument(
                containerHost, namespace, documentType, documentId, documentJson);
    }
    ...
    public String deleteDocument(
            ...
            @RequestParam(name = "document_type") String documentType,
            @RequestParam(name = "document_id") String documentId) {
        return vespaDocumentClient.deleteDocument(containerHost, namespace, documentType, documentId);
    }

    @GetMapping(
            value = "/api/document/get",
            produces = {"application/json"})
    @ResponseBody
    public String getDocument(
            ...
            @RequestParam(name = "document_type") String documentType,
            @RequestParam(name = "document_id") String documentId) {
        return vespaDocumentClient.getDocument(containerHost, namespace, documentType, documentId);
    }
}
